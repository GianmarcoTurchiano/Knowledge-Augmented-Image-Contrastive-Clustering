...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_triples_file', type=str)
    ...
    df_triples.to_csv(args.output_triples_file, index=False)
    ...
    df_labels.to_csv(args.output_labels_file, index=False)
